...
# تم التعريب بواسطه سورس تروكس بموجب حقوق النشر تخمط اذكر المصدر لاهينك 
...
𝁫  __بواسطة  {BOT_NAME} __""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("‹ رجوع الا القائمه الرئيسيه ›", callback_data="cbstart")]]
        ),
    )
...
𝁫  __بواسطة {BOT_NAME} __""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("‹ رجوع الا القائمه الرئيسيه ›", callback_data="cbcmds")]]
        ),
    )
...
#تم تعريب وتعديل هذا الملف بواسطه تروكس تخمط اختك انيجها 😂
